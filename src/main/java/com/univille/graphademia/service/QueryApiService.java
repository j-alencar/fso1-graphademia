...
public class QueryApiService {
    ...
    public static String procurarObraPorTitulo(String titulo) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) { 
                ...
                // Converter o JSON para objeto Java
                Gson gson = new Gson();
                RespostaApiService apiResponse = gson.fromJson(response.toString(), RespostaApiService.class);

                // Se houver dados, retornar o paperId da primeira obra
                if (apiResponse.getDados() != null && !apiResponse.getDados().isEmpty()) {
                    String paperId = apiResponse.getDados().get(0).getPaperId();
    ...
    public static List<String> procurarDetalhesObra(String id) {
            ...
            try {
                ...
                switch (responseCode) {
                    case HttpURLConnection.HTTP_OK -> {
                        ...
                        // Verificar se há referências e coletá-las
                        if (jsonResponse.has("references")) {
                            ...
                            for (var reference : jsonResponse.getAsJsonArray("references")) {
                                ...
                                referencesList.add("paperId: " + paperId + ", title: " + title);
                            }
